...
from imsclient.clients import get_missing_intervals, get_next_timeslice
...
def test_get_missing_interval():
    ...
    missing = get_missing_intervals(df, start_time="2018-01-18 05:00:00", stop_time="2018-01-18 06:00:00", ts=ts, read_type=ReaderType.INT)
